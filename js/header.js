...
document.querySelectorAll(".headerButton")[0].onclick = function () {
  if (headerStatus == 0) {
    // document.querySelector(".headerForSmallDevices").style.WebkitTransform = "translate3d(0, 325px, 0)";
    ...
    document.querySelector(".contentWrapper").style.WebkitTransform = "translate3d(0, 280px, 0)";
    document.querySelector(".contentWrapper").style.msTransform = "translate3d(0, 280px, 0)";
    document.querySelector(".contentWrapper").style.Transform = "translate3d(0, 280px, 0)";
    headerStatus = 1;
  } else {
